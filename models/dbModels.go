...
type BudgetItem struct {
	...
	BudgetItemId string      `json:"budgetItemId" gorm:"type:uuid;index:uq_budgetitemname,unique"`

	Company   Company `json:"company" gorm:"constraint:OnUpdate:RESTRICT,OnDelete:RESTRICT"`
	CompanyId string  `json:"companyId" gorm:"not null;type:uuid;index:uq_budgetitemcode,unique"`
